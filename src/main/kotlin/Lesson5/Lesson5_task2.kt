...
fun main() {
    ...
    // считываем год рождения посетителя
    val userAgeYear = readLine()!!.toInt()

    // высчитываем количество лет посетителя

    val countAge = currentYear - userAgeYear
...
18 лет, показывали экран со скрытым контентом (выводили это сообщение в консоль в качестве имитации).
